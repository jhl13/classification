...
__C.CLS                         = edict()
__C.CLS.DATASET                 = "ifood-251" # ifood-251 or food-462
...
__C.TRAIN.SAVE_DIR              = "../model_zoo/food_classification/baseline_2"
__C.TRAIN.INPUT_SIZE            = 224
__C.TRAIN.BATCH_SIZE            = 1
__C.TRAIN.DATA_AUG              = True
__C.TRAIN.LEARNING_RATE         = 1e-3
__C.TRAIN.MOVING_AVE_DECAY      = 0.9
__C.TRAIN.INITIAL_WEIGHT        = "../model_zoo/food_classification/baseline_2"
